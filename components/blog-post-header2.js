...
const BlogPostHeader2 = (props) => {
  return (
    <>
      ...
      <style jsx>
        {`
          .blog-post-header2-blog-post-header3 {
            display: flex;
            position: relative;
            align-items: center;
          }
          .blog-post-header2-max-width {
          ...
          .blog-post-header2-section-title {
            align-items: flex-start;
          }
          .blog-post-header2-title {
            align-items: flex-start;
          }
          .blog-post-header2-content {
            gap: var(--dl-space-space-halfunit);
            display: flex;
            align-items: center;
          }
          .blog-post-header2-content1 {
            gap: var(--dl-space-space-oneandhalfunits);
            display: flex;
            align-items: flex-start;
            flex-direction: column;
          }
          .blog-post-header2-text1 {
            text-align: center;
          }
          .blog-post-header2-content2 {
            display: flex;
            align-items: flex-start;
            flex-direction: column;
          }
          .blog-post-header2-author {
            gap: var(--dl-space-space-halfunit);
            display: flex;
          }
          .blog-post-header2-time {
            gap: 8px;
            display: flex;
            align-items: center;
          }
          .blog-post-header2-share-buttons {
            gap: var(--dl-space-space-halfunit);
            display: flex;
            align-items: flex-start;
          }
          .blog-post-header2-container {
            flex: 1;
            height: 560px;
            display: flex;
            align-self: center;
...
BlogPostHeader2.defaultProps = {
  avatarName: 'EcoWarrior123',
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1604872715218-1d3c2264ced5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMDgwNDg4M3w&ixlib=rb-4.0.3&q=80&w=1080',
  readTime: '5 minutes',
  blogPostImageAlt:
    'Illustration of a person holding a globe surrounded by green leaves',
  blogPostTitle: 'Empowering Individuals to Take Action for the Environment',
