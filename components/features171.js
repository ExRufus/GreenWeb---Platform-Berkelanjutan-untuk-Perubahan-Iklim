        ...
        <div className="features171-max-width thq-section-max-width">
          ...
          <div className="features171-content">
            <div className="features171-section-title">
              <span className="thq-body-small features171-text">
...
Features171.defaultProps = {
  ...
  feature1ImageSrc:
    'https://images.unsplash.com/photo-1572949645841-094f3a9c4c94?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMDgwNDY2NXw&ixlib=rb-4.0.3&q=80&w=1080',
  feature1ImageAlt: 'Image of person calculating carbon footprint',
  feature1Description:
    'Use our tools to calculate and track your carbon footprint over time, and receive personalized tips on how to reduce it.',
}
